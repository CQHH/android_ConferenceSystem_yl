 ...
 * @author enmaoFu
 */
public class ManagerAddDepartmentDialog extends Dialog {
    ...
    public ManagerAddDepartmentDialog(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_manager_department);
