...
public class UploadFileDialog extends Dialog {
    ...
    private void init(){
        ...
        fileBtn = (TextView)findViewById(R.id.file_btn);
    }
   ...
   public void setSelectBtn(String str){
    ...
    public String getFilePath(){
        return filePath.getText().toString().trim();
    }
   ...
   public void setSelectOnClick(View.OnClickListener clickListener){
       fileBtn.setOnClickListener(clickListener);
   }
