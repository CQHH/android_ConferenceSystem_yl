 ...
 * @author enmaoFu
 */
public class ManagerUpDepartmentDialog extends Dialog {
    ...
    public ManagerUpDepartmentDialog(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_manager_up_department);
