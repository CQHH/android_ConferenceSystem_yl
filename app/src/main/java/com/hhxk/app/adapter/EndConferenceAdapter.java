 ...
 * @author enmaoFu
 */
public class EndConferenceAdapter extends BaseQuickAdapter<EndConferencePojo,BaseViewHolder> {

    private String hostStr = "暂无";

    public EndConferenceAdapter(int layoutResId, List<EndConferencePojo> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, EndConferencePojo item) {
