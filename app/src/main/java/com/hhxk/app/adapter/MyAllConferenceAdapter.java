 ...
 * @author enmaoFu
 */
public class MyAllConferenceAdapter extends BaseQuickAdapter<MyAllConferencePojo,BaseViewHolder> {

    private String hostStr = "暂无";

    public MyAllConferenceAdapter(int layoutResId, List<MyAllConferencePojo> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, MyAllConferencePojo item) {
