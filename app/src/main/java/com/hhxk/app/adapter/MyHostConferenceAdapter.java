...
/**
 * @title  我的会议-我主持的会议适配器
 * @date   2019/02/21
 * @author enmaoFu
 */
public class MyHostConferenceAdapter extends BaseQuickAdapter<MyHostConferencePojo,BaseViewHolder> {

    private String hostStr = "暂无";

    public MyHostConferenceAdapter(int layoutResId, List<MyHostConferencePojo> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, MyHostConferencePojo item) {
