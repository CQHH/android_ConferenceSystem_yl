...
/**
 * @title  所有会议-正在进行会议适配器
 * @date   2019/02/21
 * @author enmaoFu
 */
public class OngoinConferenceAdapter extends BaseQuickAdapter<OngoinConferencePojo,BaseViewHolder> {

    private String hostStr = "暂无";

    public OngoinConferenceAdapter(int layoutResId, List<OngoinConferencePojo> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, OngoinConferencePojo item) {
