 ...
 * @author enmaoFu
 */
public class NotConferenceAdapter extends BaseQuickAdapter<NotConferencePojo,BaseViewHolder> {

    private String hostStr = "暂无";

    public NotConferenceAdapter(int layoutResId, List<NotConferencePojo> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, NotConferencePojo item) {
